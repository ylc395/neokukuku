...
// General settings
const TITLE = '示例版面2';	//Name of this imageboard
...
const LANGUAGE = 'zh';				//Language. Fikaba provides en and ja by default
const FOOTTEXT = '';				//Extra footer text, for disclaimers and such. Can be left empty

// Database settings
const POSTTABLE = 'postsSLBM2';			//Post table (NOT DATABASE)
const BANTABLE = 'banlist';			//Bans table (NOT DATABASE)
const MANATABLE = 'admins';			//Manager (admin, mod, janitor) table
...
const MAX_KB = 512;				//Maximum upload size in KB
...
const WEBM_ENABLED = false;			//Whether or not upload of WebM files is allowed
...
const PHP_SELF = 'index.php';		//Name of main script file (if ECHOALL, you probably want 'index.php')
...
const THREADLIMIT =  1000;			//Maxium number of entries
const BUMPLIMIT = 100;				//Maximum topic bumps
const COLLAPSENUM = 7;				//Number of replies to show in the index
const TRIPKEY = '#';				//this character is displayed before tripcodes

// Spam/flood protection
const RENZOKU = 20;				//Seconds between posts (floodcheck)
const RENZOKU2 = 60;				//Seconds between image posts (floodcheck)
const BR_CHECK = 20;				//Max lines per post (0 = no limit)
